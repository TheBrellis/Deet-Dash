$(document).ready(function() {
    ...
    function dailyWeather(){
        ...
        var currentURL = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=imperial&appid=e4c0273e5ea54d9af35c603a4dae870e`
      // for daily weather
        $.ajax({
            url: currentURL,
            method: "GET",
           ...
           var dayIconURL = `https://openweathermap.org/img/wn/${dayIcon}.png`
